...
class playerDataSpider(scrapy.Spider):
    ...
    start_urls = [
        ...
        "https://nba.hupu.com/players/robertcovington-4851.html" #科文顿
    ...
    def parse(self, response):
        for each in response.xpath("//div[@class='team_hig'][1]//table[@class='players_table bott bgs_table'][1]/tbody/tr[@class='color_font1 borders_btm'][position()=2]"):
            item = PlayersItem()
